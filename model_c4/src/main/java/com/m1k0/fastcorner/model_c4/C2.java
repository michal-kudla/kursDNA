...
/**
 * Diagram C2 - lista kontenerow
 * - kontener aplikacji mobilnej - emitera
 * - kontener API - zaplecze
 * - kontener Bazy Danych
 * - kontener klienta - przeglądarka internetowa
 */
public class C2
{
    ...
    public static void main(String[] args) throws Exception {
        ...
        Workspace workspace = new Workspace("FastCorner", "C2 model of FastCorner  system.");
        ...
        Container mobileApp = softwareSystem.addContainer(
                "Aplikacja mobilna",
                "Dostarcza ograniczoną funkcjonalność bankowości online dla klientów",
                "Xamarin");
        Container apiApplication = softwareSystem.addContainer(
                "API",
                "Dostarcza funkcjonalność bankowości online poprzez JSON/HTTPS API.",
                "Java i Spring MVC");
        Container database = softwareSystem.addContainer(
        ...
        emiterUser.uses(mobileApp, "Używa", "");
